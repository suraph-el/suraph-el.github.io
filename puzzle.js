...
//function for setting the position and css for the filled squares
    $('#puzzlearea div').each(function ()
    {
        ...
        $(this).css({"left": leftpx, "top": toppx, "backgroundImage": "url('img/shrek.jpg')", "backgroundPosition": -x + 'px ' + (-y) + 'px'});
        count++;
    });

    var images= ["url('img/shrek.jpg')", "url('img/tomm.jpg')", "url('img/donkey.jpeg')"];
    var index=0;
